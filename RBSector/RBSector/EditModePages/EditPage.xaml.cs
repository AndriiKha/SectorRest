...
namespace RBSector.EditModePages
{
    /// <summary>
    ...
    public sealed partial class EditPage : Page
    {
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (_presenter.SelectedTabRecid != -1 && _presenter.CheckNameUnique<CategoryViewModel>(EditCreateName.Text))
                {
                    if (!isEdit)
        ...
        private void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (PartEdit == EditPart.TAB)
            {
                result = tb_srv.Delete(_presenter.SelectedTabRecid);
            }
            else if (PartEdit == EditPart.CATEGORY)
            {
                result = cat_srv.Delete(_presenter.SelectedCategoryRecid);
            }
